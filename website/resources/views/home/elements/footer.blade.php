                ...
                <div class="col-lg-4 col-md-4">
                    <div class="footer-widget">
                        <a class="nav-footer-logo" href="index.html">
                            <img src="/img/logow.png" alt="logo" style="height: 86px">
                        </a>
                        <div class="footer-add">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro vitae labore nulla sint minima obcaecati iure illum quidem. Illo quis consequuntur cumque, enim aliquid reiciendis quae. Sequi nam neque facere?</p>
                            <p>Address</p>
                            <p>Phone Number</p>
                            <p>Email:</p>
                        </div>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-menu">
                            ...
                            <li><a href="checkout.html">Checkoutadfasdasdasd</a></li>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6">
                    <p class="mb-0">© 2023 DingDong. Designd By <a href="#">Ducky</a> All Rights Reserved</p>
                </div>
