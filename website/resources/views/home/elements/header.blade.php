                ...
                <ul class="nav-menu">
                    ...
                    <li><a href="#">About Us<span class="submenu-indicator"></span></a>
                        <ul class="nav-dropdown nav-submenu">
                            ...
                            <li><a href="#"></a></li>
                            <li>
                                <a href="#">Home Layout 11
                                    {{-- <span class="ms-2 label-new">New</span> --}}
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li><a href="#">Listings<span class="submenu-indicator"></span></a>
                        <ul class="nav-dropdown nav-submenu">
                            <li><a href="#">List Layout<span class="submenu-indicator"></span></a>
                                <ul class="nav-dropdown nav-submenu">
                                    <li><a href="list-layout-new.html">List Layout Simple<span
                                                class="ms-2 label-new">New</span></a></li>
                                    <li><a href="list-layout-new-3.html">List Layout Modern<span
                                                class="ms-2 label-new">New</span></a></li>
                                    <li><a href="list-layout-new-2.html">List Layout Advance<span
                                                class="ms-2 label-new">New</span></a></li>
                            ...
                            <li><a href="#">With Map Property<span class="submenu-indicator"></span></a>
                                <ul class="nav-dropdown nav-submenu">
                                    ...
                                    <li><a href="half-map-2.html">Half Map Search 02<span
                                                class="ms-2 label-new">New</span></a></li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li><a href="#">Features<span class="submenu-indicator"></span></a>
                        <ul class="nav-dropdown nav-submenu">
                            <li><a href="#">Single Property<span class="submenu-indicator"></span></a>
                                <ul class="nav-dropdown nav-submenu">
                                    ...
                                    <li><a href="single-property-4.html">Single Property 4<span
                                                class="ms-2 label-new">New</span></a></li>
                                </ul>
                            </li>
                            <li><a href="#">Agencies & Agents<span class="submenu-indicator"></span></a>
                                <ul class="nav-dropdown nav-submenu">
                            ...
                            <li><a href="#">My Account<span class="submenu-indicator"></span></a>
                                <ul class="nav-dropdown nav-submenu">
