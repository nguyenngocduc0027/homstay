        ...
        <div class="listing-img-wrapper p-2">
            <div class="list-img-slide position-relative">
                ...
                <div class="click rounded-3 overflow-hidden mb-0">
                    <div><a href="single-property-1.html"><img src="/img/p-1.jpg" class="img-fluid" alt="" /></a></div>
                </div>
            </div>
        </div>
            ...
            <div class="listing-detail-wrapper">
                <div class="listing-short-detail-wrap">
                    <div class="listing-short-detail">
                        <h4 class="listing-name fw-semibold fs-5 mb-1"><a href="single-property-1.html">The Green Canton Chrysler{{$i}}</a></h4>
            ...
            <div class="price-features-wrapper">
                <div class="list-fx-features d-flex align-items-center justify-content-between">
                    <div class="listing-card d-flex align-items-center">
                        <span class="text-muted-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit cupiditate ullam voluptatem natus, neque nemo adipisci harum reprehenderit voluptate perspiciatis quo unde dolor blanditiis. Voluptatibus nulla dolorem neque porro animi.</span>
                    </div>
