    ...
    <div class="container">
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-xl-12 col-lg-12 col-md-12">
                ...
                <div class="counter-info-groups" style="margin-top: 0rem !important">
        ...
        <div class="row align-items-center justify-content-between" style="margin-top: 1rem !important">
            ...
            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12">
                <div class="trustscrore-wrap">
                    ...
                    <div class="trustscrore-info">
                        ...
                        <div class="trustscrore-brand"><img src="/img/brand.png" class="img-fluid" alt=""></div>
                    </div>
                ...
                <div class="single-reviews">
                    ...
                    <div class="single-item-reviews">
                        ...
                        <div class="single-item-reviews-info">
                            ...
                            <p class="text-primary">Airbnb Leader</p>
                        </div>
                    </div>
