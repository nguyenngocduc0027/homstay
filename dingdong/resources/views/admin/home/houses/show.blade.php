        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="pt-2 pb-2 d-flex justify-content-end">
                    <a href="{{ route('create_houses') }}" type="button" class="btn btn-primary"><i
                        ...
                        <table class="table table-striped" id="data-tables">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('detail_houses') }}" type="button" class="btn btn-success"><i
                                                class="bi bi-eye"></i></a>
                                        <a href="{{ route('update_houses') }}" type="button" class="btn btn-primary"><i
